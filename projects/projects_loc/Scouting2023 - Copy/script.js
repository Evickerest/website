...
const teleopQualShow = document.querySelectorAll("input[name='endgame-driving']");
const teleopQual = document.querySelector(".teleop-qual");
const teleopQualRadio = document.querySelectorAll("input[name='teleop-qual']");

teleopQualShow.forEach( button => {
    button.addEventListener("change", ()=> {
        if( button.value == "Engaged" || button.value == "Docked"){
            teleopQual.style.display = "flex";
        } else {
            teleopQual.style.display = "none";
            teleopQualRadio.forEach( radio => {
                radio.checked = false;
            })
        }
    });
